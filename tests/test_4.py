...
def test_parse_input_returns_dict_of_two_sets_of_numbers():
    given_input_path = Path("test_input/test_input_4_1.txt")
    parsed_input = day_4.parse_input(given_input_path)
...
def test_winning_gives_more_scratchcards():
    given_input_path = Path("test_input/test_input_4_1.txt")
    given_cards = day_4.parse_input(given_input_path)
...
def test_solving_part_one_gives_expected_value():
    given_input_path = Path("test_input/test_input_4_1.txt")
    answer = day_4.solve_part_one(given_input_path)
    expected_answer = 13
...
def test_solving_part_two_gives_expected_value():
    given_input_path = Path("test_input/test_input_4_1.txt")
    answer = day_4.solve_part_two(given_input_path)
    expected_answer = 30
    assert answer == expected_answer
